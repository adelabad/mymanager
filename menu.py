...
class Filemanager(QtGui.QWidget):
    ...
    def initui(self):
        ...
        self.copy_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL+QtCore.Qt.Key_C), self.listview, self.copy_btn_clicked)
        self.paste_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL+QtCore.Qt.Key_V), self.listview, self.paste_btn_clicked)
        self.cut_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL+QtCore.Qt.Key_X), self.listview, self.cut_btn_clicked)
        self.del_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.Key_Delete), self.listview, self.remove_btn_clicked)
        self.rename_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.Key_F2), self.listview, self.rename_btn_clicked)
        self.new_win_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL+QtCore.Qt.Key_N), self.listview, self.new_win_clicked)
        self.new_folder_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.CTRL+QtCore.Qt.Key_A), self.listview, self.new_folder_clicked)
        self.exit_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.Key_Escape), self.listview, self.exit_clicked)
        self.back_hot = QtGui.QShortcut(QtGui.QKeySequence(QtCore.Qt.Key_Backspace), self.listview, self.back_clicked)
